                  ...
                  <Tab eventKey="info" title="Basic info">
                    <div className="mt-4">
                      <div className="row">
                        ...
                        <div className="col-md-8 col-6">Nasbeer Ahammed</div>
                      </div>
                      <hr />
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-8 col-6">Sep 14 1990</div>
                      </div>
                      <hr />
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-8 col-6">nazbeer.ahammed@gmail.com</div>
                      </div>
                      <hr />
                      {/* <div className="row">
                        <div className="col-sm-3 col-md-2 col-5">
